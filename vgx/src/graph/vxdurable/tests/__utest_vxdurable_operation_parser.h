 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_parser.h
 * Author:  Stian Lysne <...>
 * 
...
#ifndef __UTEST_VXDURABLE_OPERATION_PARSER_H
#define __UTEST_VXDURABLE_OPERATION_PARSER_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_parser ) {
