 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_emitter.h
...
#ifndef __UTEST_VXDURABLE_OPERATION_EMITTER_H
#define __UTEST_VXDURABLE_OPERATION_EMITTER_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_emitter ) {
