...
`pyvgx.F_DEPTH = 524288`

Vertex found at this depth (hops from starting point.) Applicable for <<../graph/graphNavigationQuery.adoc#, navigation queries>> only. For normal queries this is 0.
