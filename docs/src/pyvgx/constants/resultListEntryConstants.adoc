...
When meta-information is requested with <<R_COUNTS>> or <<R_TIMING>> the returned result is a dictionary containing the list of results plus the requested meta-information.
