...
static __rpn_operation RpnBinaryANNCollect   = { .surface.token="anncollect",       .function.eval = __eval_nullary_anncollect,       .type = OP_NULLARY_HEAD_PREFIX,   .precedence = OPP_CALL };
