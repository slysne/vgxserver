 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_consumer_service.h
 * Author:  Stian Lysne <...>
 * 
...
#ifndef __UTEST_VXDURABLE_OPERATION_CONSUMER_SERVICE_H
#define __UTEST_VXDURABLE_OPERATION_CONSUMER_SERVICE_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_consumer_service ) {
