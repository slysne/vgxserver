 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_capture.h
...
#ifndef __UTEST_VXDURABLE_OPERATION_CAPTURE_H
#define __UTEST_VXDURABLE_OPERATION_CAPTURE_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_capture ) {
