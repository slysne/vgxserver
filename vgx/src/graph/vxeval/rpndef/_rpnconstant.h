...
static __rpn_operation RpnPushConstantVector = { .surface.token="vector",           .function.eval = __stack_push_constant_vector,    .type = OP_OBJECT_OPERAND,        .precedence = OPP_CONSTANT };
static __rpn_operation RpnPushConstantMVector= { .surface.token="M.vector",         .function.eval = __stack_push_constant_Mvector,   .type = OP_OBJECT_OPERAND,        .precedence = OPP_CONSTANT };
...
static __rpn_operation RpnPush_D_ANY         = { .surface.token="D_ANY",            .function.eval = __stack_push_constant_D_ANY,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_D_IN          = { .surface.token="D_IN",             .function.eval = __stack_push_constant_D_IN,      .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_D_OUT         = { .surface.token="D_OUT",            .function.eval = __stack_push_constant_D_OUT,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_D_BOTH        = { .surface.token="D_BOTH",           .function.eval = __stack_push_constant_D_BOTH,    .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_ANY         = { .surface.token="M_ANY",            .function.eval = __stack_push_constant_M_ANY,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_STAT        = { .surface.token="M_STAT",           .function.eval = __stack_push_constant_M_STAT,    .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_SIM         = { .surface.token="M_SIM",            .function.eval = __stack_push_constant_M_SIM,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_DIST        = { .surface.token="M_DIST",           .function.eval = __stack_push_constant_M_DIST,    .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_LSH         = { .surface.token="M_LSH",            .function.eval = __stack_push_constant_M_LSH,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_INT         = { .surface.token="M_INT",            .function.eval = __stack_push_constant_M_INT,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_UINT        = { .surface.token="M_UINT",           .function.eval = __stack_push_constant_M_UINT,    .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_FLT         = { .surface.token="M_FLT",            .function.eval = __stack_push_constant_M_FLT,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_CNT         = { .surface.token="M_CNT",            .function.eval = __stack_push_constant_M_CNT,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_ACC         = { .surface.token="M_ACC",            .function.eval = __stack_push_constant_M_ACC,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_TMC         = { .surface.token="M_TMC",            .function.eval = __stack_push_constant_M_TMC,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_TMM         = { .surface.token="M_TMM",            .function.eval = __stack_push_constant_M_TMM,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
static __rpn_operation RpnPush_M_TMX         = { .surface.token="M_TMX",            .function.eval = __stack_push_constant_M_TMX,     .type = OP_ENUM_OPERAND,          .precedence = OPP_CONSTANT };
