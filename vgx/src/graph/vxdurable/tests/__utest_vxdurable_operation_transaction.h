 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_transaction.h
...
#ifndef __UTEST_VXDURABLE_OPERATION_TRANSACTION_H
#define __UTEST_VXDURABLE_OPERATION_TRANSACTION_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_transaction ) {
