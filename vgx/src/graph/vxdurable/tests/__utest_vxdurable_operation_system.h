 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_system.h
...
#ifndef __UTEST_VXDURABLE_OPERATION_SYSTEM_H
#define __UTEST_VXDURABLE_OPERATION_SYSTEM_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_system ) {
