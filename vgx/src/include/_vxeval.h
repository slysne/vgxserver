...
typedef enum __e_rpn_op_type {
  ...
  OP_NULLARY_TAIL_PREFIX    = 0x00000010 | __OP_ARGS_0 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_NULLARY_ARC_PREFIX     = 0x00000010 | __OP_ARGS_0 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_NULLARY_HEAD_PREFIX    = 0x00000010 | __OP_ARGS_0 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_UNARY_PREFIX           = 0x00000020 | __OP_ARGS_1 | __OP_CLS_PREFIX, 
  OP_UNARY_TAIL_PREFIX      = 0x00000020 | __OP_ARGS_1 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_UNARY_ARC_PREFIX       = 0x00000020 | __OP_ARGS_1 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_UNARY_HEAD_PREFIX      = 0x00000020 | __OP_ARGS_1 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_BINARY_PREFIX          = 0x00000030 | __OP_ARGS_2 | __OP_CLS_PREFIX,
  OP_BINARY_TAIL_PREFIX     = 0x00000030 | __OP_ARGS_2 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_BINARY_ARC_PREFIX      = 0x00000030 | __OP_ARGS_2 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_BINARY_HEAD_PREFIX     = 0x00000030 | __OP_ARGS_2 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_TERNARY_PREFIX         = 0x00000040 | __OP_ARGS_3 | __OP_CLS_PREFIX,
  OP_TERNARY_TAIL_PREFIX    = 0x00000040 | __OP_ARGS_3 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_TERNARY_ARC_PREFIX     = 0x00000040 | __OP_ARGS_3 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_TERNARY_HEAD_PREFIX    = 0x00000040 | __OP_ARGS_3 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_QUATERNARY_PREFIX      = 0x00000050 | __OP_ARGS_4 | __OP_CLS_PREFIX,
  OP_QUATERNARY_TAIL_PREFIX = 0x00000050 | __OP_ARGS_4 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_QUATERNARY_ARC_PREFIX  = 0x00000050 | __OP_ARGS_4 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_QUATERNARY_HEAD_PREFIX = 0x00000050 | __OP_ARGS_4 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_QUINARY_PREFIX         = 0x00000050 | __OP_ARGS_5 | __OP_CLS_PREFIX,
  OP_QUINARY_TAIL_PREFIX    = 0x00000050 | __OP_ARGS_5 | __OP_CLS_PREFIX | __OP_CLS_TAIL_DEREF, // lookback
  OP_QUINARY_ARC_PREFIX     = 0x00000050 | __OP_ARGS_5 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE, // traverse
  OP_QUINARY_HEAD_PREFIX    = 0x00000050 | __OP_ARGS_5 | __OP_CLS_PREFIX | __OP_CLS_TRAVERSE | __OP_CLS_HEAD_DEREF, // traverse and deref

  OP_VARIADIC_PREFIX        = 0x00000060 | __OP_ARGS_VAR | __OP_CLS_PREFIX, 
  OP_VARIADIC_THIS_PREFIX   = 0x00000060 | __OP_ARGS_VAR | __OP_CLS_PREFIX | __OP_CLS_THIS_DEREF, // deref 
