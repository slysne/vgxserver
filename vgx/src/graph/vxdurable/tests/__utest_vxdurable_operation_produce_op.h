 ...
 * 
 * Module:  vgx
 * File:    __utest_vxdurable_operation_produce_op.h
 * Author:  Stian Lysne <...>
 * 
...
#ifndef __UTEST_VXDURABLE_OPERATION_PRODUCE_OP_H
#define __UTEST_VXDURABLE_OPERATION_PRODUCE_OP_H
...
BEGIN_UNIT_TEST( __utest_vxdurable_operation_produce_op ) {
